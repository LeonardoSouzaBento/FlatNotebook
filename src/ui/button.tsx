...
export const buttonVariants = cva(
  'w-auto tracking-wide inline-flex items-center justify-center gap-2 rounded-lg ring-offset-background transition-colors disabled:pointer-events-none disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:shrink-0 relative data-w-full:w-full data-round:rounded-full focus:outline-none data-option:rounded-full data-black:text-foreground data-option:text-sm data-option:px-[0.64em]',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        sm: 'h-9 small-button',
        default: `h-10`,
        lg: 'h-11 large-text large-button',
        'icon-sm': 'size-8',
        icon: 'size-9',
        'icon-md': 'size-10',
        'icon-lg': 'size-11',
